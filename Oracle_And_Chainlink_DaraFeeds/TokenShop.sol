...
contract TokenShop is Ownable {
    ...
    // We have set the `msg.sender` to be the contract owner.
    ...
    */
    ...
    /*
    You can find the decimals for the different feeds in the 
    [Price Feeds Documentation](https://docs.chain.link/data-feeds/price-feeds/addresses?network=ethereum\&page=1#sepolia-testnet) (make sure “Show More Details” is checked).
    */
    ...
    /*
    `receive` functions are special functions in Solidity that are automatically executed when someone sends ETH directly to the contract address without specifying any function to call. 
     They don't take any arguments and don't return any values.
    */
    ...
    // a way for the owner of the smart contract to withdraw the ETH in the contract
