...
contract MessageSender is Ownable {
    ...
    /*
     * The LINK token and Router are set **dynamically** in the constructor rather than hard-coded.
     * This is because we need to pass these through from Chainlink Local.
    */
